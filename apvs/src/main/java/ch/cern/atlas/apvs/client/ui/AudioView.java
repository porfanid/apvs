...
public class AudioView extends VerticalPanel implements Module{
	...
	private List<String> field = Arrays.asList( new String[] {"Activity","Call","Conference"});
	private List<Class<?>> classField = Arrays.asList(new Class<?>[] {TextCell.class, ButtonCell.class, ButtonCell.class});

...
{
    protected final Map<Object, Long> _objVisited = new IdentityHashMap<Object, Long>();
    protected final Map<Object, Long> _objsReferenced = new IdentityHashMap<Object, Long>();
    ...
    protected void writeType(Object obj) throws IOException
    {
        _out.write("\"@type\":\"");
